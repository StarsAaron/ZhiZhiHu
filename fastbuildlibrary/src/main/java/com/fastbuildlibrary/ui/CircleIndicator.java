package com.fastbuildlibrary.ui;
 ...
 * Viewpager  页面指示器
 *
 * 默认使用该类作为OnPageChangeListener
 *
 * 使用：
 * mViewPager = (ViewPager)findViewById(R.id.main_view_pager);
 * mCircleIndicator = (CircleIndicator)findViewById(R.id.pager_indicator);
...
public class CircleIndicator extends LinearLayout implements OnPageChangeListener {
    ...
    private int mAnimatorResId = R.animator.ci_scale_with_alpha;

    private int mAnimatorReverseResId = 0;

    private int mIndicatorBackgroundResId = R.drawable.ci_white_radius;

    private int mIndicatorUnselectedBackgroundResId = R.drawable.ci_white_radius;
    ...
    private void handleTypedArray(Context context, AttributeSet attrs) {
        ...
        mAnimatorResId = typedArray.getResourceId(R.styleable.CircleIndicator_ci_animator,
                R.animator.ci_scale_with_alpha);
    ...
    public void configureIndicator(int indicatorWidth, int indicatorHeight, int indicatorMargin) {
        ...
        configureIndicator(indicatorWidth, indicatorHeight, indicatorMargin,
                R.animator.ci_scale_with_alpha, 0, R.drawable.ci_white_radius, R.drawable.ci_white_radius);
    }
    ...
    private void checkIndicatorConfig(Context context) {
        ...
        mAnimatorResId = (mAnimatorResId == 0) ? R.animator.ci_scale_with_alpha : mAnimatorResId;
        ...
        mIndicatorBackgroundResId = (mIndicatorBackgroundResId == 0) ? R.drawable.ci_white_radius
                : mIndicatorBackgroundResId;
        mIndicatorUnselectedBackgroundResId =
